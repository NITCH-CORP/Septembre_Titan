  ...
  void _initHistory() async {
    try {
      ...
      final activiteDocs = await databases.listDocuments(
          ...
          queries: [Query.equal('client', clientId)]);
              ...
              children: [
                Row(
                  children: [
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                       element.activite.data['categorie'] == 'CONNECTIONCLIENT' ? Text(
                            'Connexion',
                ...
                Text('Vous vous ete connecter a votre compte',style:TextStyle(fontSize:18)),
