...
class PathScreen extends StatefulWidget {
  ...
  PathScreen({super.key, required this.destination});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        MaterialPageRoute(builder: (context) => ChoosePilote())
                        );
                      },
                      child: Container(
        ...
        body: SizedBox(
          height: size.height,
          width: size.width,
          child: isLoading == true ? const Center(child: CircularProgressIndicator()) : Stack(
            children: [
            OSMFlutter( 
