...
class ClientPathScreen extends StatefulWidget {
  //GeoPoint? destination;
  Document? trajet;
  ClientPathScreen({super.key, required this.trajet});

  @override
  State<ClientPathScreen> createState() => _ClientPathScreenState();
}

class _ClientPathScreenState extends State<ClientPathScreen> {
  double distance = 0;
  ...
  void _update(GeoPoint point) async {
    ...
    final piloteDoc = await databases.updateDocument(
        ...
        documentId: widget.trajet!.data['pilote']['\$id'],
